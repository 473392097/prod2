...
<form id="pageSubmit" class="layui-form">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="prd_name" value="${param.prd_name! ''}" autocomplete="off" class="layui-input">
        </div>
        <label class="layui-form-label">明细名称</label>
        <div class="layui-input-inline">
            <input type="text" name="prd_dtl_name"  value="${param.prd_dtl_name! ''}" autocomplete="off" class="layui-input">
        </div>
